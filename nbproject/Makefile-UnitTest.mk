...
${OBJECTDIR}/src/adbncfs.o: src/adbncfs.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/adbncfs.o src/adbncfs.cpp

${OBJECTDIR}/src/fileinfoCache.o: src/fileinfoCache.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fileinfoCache.o src/fileinfoCache.cpp

${OBJECTDIR}/src/main.o: src/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp

${OBJECTDIR}/src/mountInfo.o: src/mountInfo.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mountInfo.o src/mountInfo.cpp

${OBJECTDIR}/src/spawn.o: src/spawn.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/spawn.o src/spawn.cpp

${OBJECTDIR}/src/userInfo.o: src/userInfo.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/userInfo.o src/userInfo.cpp
...
${TESTDIR}/tests/mountPointTestRunner.o: tests/mountPointTestRunner.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -Isrc -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/mountPointTestRunner.o tests/mountPointTestRunner.cpp


${TESTDIR}/tests/testMountPoint.o: tests/testMountPoint.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -Isrc -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testMountPoint.o tests/testMountPoint.cpp


${TESTDIR}/tests/adbncFileSystemTestRunner.o: tests/adbncFileSystemTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -Isrc -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/adbncFileSystemTestRunner.o tests/adbncFileSystemTestRunner.cpp


${TESTDIR}/tests/testAdbncFileSystem.o: tests/testAdbncFileSystem.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -Isrc -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testAdbncFileSystem.o tests/testAdbncFileSystem.cpp


${TESTDIR}/tests/testUserInfo.o: tests/testUserInfo.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -Isrc -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/testUserInfo.o tests/testUserInfo.cpp


${TESTDIR}/tests/userInfoTestRunner.o: tests/userInfoTestRunner.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -Isrc -std=c++11 `cppunit-config --cflags` -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/userInfoTestRunner.o tests/userInfoTestRunner.cpp
...
${OBJECTDIR}/src/adbncfs_nomain.o: ${OBJECTDIR}/src/adbncfs.o src/adbncfs.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/adbncfs_nomain.o src/adbncfs.cpp;\
	else  \
...
${OBJECTDIR}/src/fileinfoCache_nomain.o: ${OBJECTDIR}/src/fileinfoCache.o src/fileinfoCache.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fileinfoCache_nomain.o src/fileinfoCache.cpp;\
	else  \
...
${OBJECTDIR}/src/main_nomain.o: ${OBJECTDIR}/src/main.o src/main.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main_nomain.o src/main.cpp;\
	else  \
...
${OBJECTDIR}/src/mountInfo_nomain.o: ${OBJECTDIR}/src/mountInfo.o src/mountInfo.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/mountInfo_nomain.o src/mountInfo.cpp;\
	else  \
...
${OBJECTDIR}/src/spawn_nomain.o: ${OBJECTDIR}/src/spawn.o src/spawn.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/spawn_nomain.o src/spawn.cpp;\
	else  \
...
${OBJECTDIR}/src/userInfo_nomain.o: ${OBJECTDIR}/src/userInfo.o src/userInfo.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -g -DADBNCTEST -DDEBUG -D_FILE_OFFSET_BITS=64 -std=c++11 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/userInfo_nomain.o src/userInfo.cpp;\
	else  \
